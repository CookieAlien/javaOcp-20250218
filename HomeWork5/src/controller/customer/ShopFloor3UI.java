...
public class ShopFloor3UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShopFloor3UI frame = new ShopFloor3UI();
	...
	public ShopFloor3UI() {
		...
		JLabel floorTitleLabel = new JLabel("歡迎來到3樓家飾部！");
		...
		JLabel lblNewLabel_1 = new JLabel("各類小型居家用品應有盡有！");
		...
		nextButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FileTool.save(shoppingList, "ShoppingList.txt");
				new ShopFloor2UI().setVisible(true);
				dispose();
			}
		});
	...
	private void populateShop() {
		...
		products = productServiceImpl.getProductsByCategory("decoration");
