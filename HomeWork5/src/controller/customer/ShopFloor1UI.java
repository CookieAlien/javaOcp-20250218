...
public class ShopFloor1UI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShopFloor1UI frame = new ShopFloor1UI();
	...
	public ShopFloor1UI() {
		...
		JLabel floorTitleLabel = new JLabel("歡迎來到1樓美食小站！");
		...
		JLabel lblNewLabel_1 = new JLabel("逛累了嗎？歡迎來這裡用餐，或是買回家享用！");
